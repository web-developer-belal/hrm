...
let themesettings = `
<div class="sidebar-contact fixed top-0 -translate-y-1/2 right-[-350px] w-[350px] h-auto bg-white box-border transition-all duration-500 z-[40]">
    <div class="toggle-theme absolute w-[35px] text-center cursor-pointer bg-primary top-[225px] right-[350px] p-[6px] h-[35px] text-white rounded-tl-sm rounded-bl-sm" data-drawer-target="theme-setting" data-drawer-show="theme-setting" aria-controls="theme-setting" data-drawer-placement="right"><i class="fa fa-cog fa-w-16 fa-spin"></i></div>
    </div>
    <div class="sidebar-themesettings fixed top-0 right-0 bottom-0 z-[9999] h-screen translate-x-full bg-white w-[400px]" id="theme-setting">
    <div class="p-4 flex items-center justify-between bg-dark">
        <div>
            <h3 class="mb-1 text-white">Theme Customizer</h3>
            <p class="text-light">Choose your themes & layouts etc.</p>
        </div>
        <a href="#" class="custom-btn-close end-2.5 text-white bg-gray-500 hover:bg-danger hover:text-white rounded-full text-xs leading-normal size-5 ms-auto inline-flex justify-center items-center"  data-drawer-hide="theme-setting"><i class="ti ti-x"></i></a>
    </div>
    <div class="themesettings-inner h-[80vh] overflow-y-auto p-4">
        <div class="accordion accordion-customicon1 accordions-items-seperate" id="settingtheme" data-accordion="open">
            <div class="accordion-item border rounded mb-4">
                <h2 class="accordion-header">
                    <button class="w-full p-3 rounded text-dark text-start text-[16px]" type="button" data-accordion-target="#layoutsetting" aria-expanded="true" aria-controls="collapsecustomicon1One">
                        Select Layouts
                    </button>
                </h2>
                <div id="layoutsetting" class="">
            ...
            <div class="accordion-item border rounded mb-4">
                <h2 class="accordion-header">
                    <button class="w-full p-3 rounded text-dark text-start text-[16px] fs-16" type="button" data-accordion-target="#sidebarsetting" aria-expanded="true">
                        Layout Width
                    </button>
                </h2>
                <div id="sidebarsetting">
                    <div class="accordion-body p-3">
                        <div class="flex items-center">
                            <div class="theme-width m-1 me-2">
                                <input type="radio" name="width" id="fluidWidth" value="fluid" checked>
                                <label for="fluidWidth" class="block rounded fs-12">Fluid Layout
                                </label>
                            </div>
                            <div class="theme-width m-1">
                                <input type="radio" name="width" id="boxWidth" value="box">
                                <label for="boxWidth" class="block rounded fs-12">Boxed Layout
                                </label>
                            </div>
                        </div>  
                    </div>
            ...
            <div class="accordion-item border rounded mb-4">
                <h2 class="accordion-header">
                    <button class="w-full p-3 rounded text-dark text-start text-[16px] fs-16" type="button" data-accordion-target="#cardsetting" aria-expanded="true" aria-controls="collapsecustomicon1One">
                        Card Layout
                    </button>
                </h2>
                <div id="cardsetting">
            ...
            <div class="accordion-item border rounded mb-4">
                <h2 class="accordion-header">
                    <button class="w-full p-3 rounded text-dark text-start text-[16px] fs-16" type="button" data-accordion-target="#sidebarsettings" aria-expanded="true">
                        Sidebar Color
                    </button>
                </h2>
                    ...
                    <div class="accordion-body p-3">
                       <div class="flex items-center">
                            <div class="theme-colorselect m-1 me-2">
                                ...
                                <label for="lightSidebar" class="block rounded mb-2">
                                </label>
                            </div>
                            <div class="theme-colorselect m-1 me-2">
                                <input type="radio" name="sidebar" id="darkgreenSidebar" value="darkgreen">
                                <label for="darkgreenSidebar" class="block rounded bg-[#111926] mb-2">
                                </label>
                            </div>
                            <div class="theme-colorselect m-1 me-2">
                                <input type="radio" name="sidebar" id="nightblueSidebar" value="nightblue">
                                <label for="nightblueSidebar" class="block rounded bg-[#0F0F41] mb-2">
                                </label>
                            </div>
                            <div class="theme-colorselect m-1 me-2">
                                <input type="radio" name="sidebar" id="darkgraySidebar" value="darkgray">
                                <label for="darkgraySidebar" class="block rounded bg-[#2E2E48] mb-2">
                                </label>
                            </div>
                            <div class="theme-colorselect m-1 me-2">
                                <input type="radio" name="sidebar" id="royalblueSidebar" value="royalblue">
                                <label for="royalblueSidebar" class="block rounded bg-[#0039C6] mb-2">
                                </label>
                            </div>
                            <div class="theme-colorselect m-1 me-2">
                                <input type="radio" name="sidebar" id="indigoSidebar" value="indigo">
                                <label for="indigoSidebar" class="block rounded bg-indigo mb-2">
                                </label>
                            </div>                            
                            <div class="theme-colorselect m-1 mt-0 hidden">
            ...
            <div class="accordion-item border rounded mb-4">
                <h2 class="accordion-header">
                    <button class="w-full p-3 rounded text-dark text-start text-[16px] fs-16" type="button" data-accordion-target="#modesetting" aria-expanded="true">
                        Color Mode
                    </button>
                </h2>
                <div id="modesetting">
                       ...
                       <div class="grid grid-cols-12 gap-x-3">
                            <div class="col-span-6">
                                <div class="theme-mode">
                                    ...
                                    <label for="lightTheme" class="p-2 rounded font-medium w-full block">                            
                                        <span class="avatar avatar-md inline-flex items-center justify-center rounded me-2"><i class="ti ti-sun-filled"></i></span>Light Mode
                                    </label>
                                </div>
                            </div>
                            <div class="col-span-6">
                                <div class="theme-mode">
                                    ...
                                    <label for="darkTheme" class="p-2 rounded font-medium w-full block">                         
                                        <span class="avatar avatar-md inline-flex items-center justify-center rounded me-2"><i class="ti ti-moon-filled"></i></span>Dark Mode
                                    </label>
                                </div>
                            </div>
                        </div>
            ...
            <div class="accordion-item border rounded mb-4">
                <h2 class="accordion-header">
                    <button class="w-full p-3 rounded text-dark text-start text-[16px] fs-16" type="button" data-accordion-target="#sizesetting" aria-expanded="true" aria-controls="collapsecustomicon1One">
                        Sidebar Size
                    </button>
                </h2>
                <div id="sizesetting">
            ...
            <div class="accordion-item border rounded mb-4">
                <h2 class="accordion-header">
                    <button class="w-full p-3 rounded text-dark text-start text-[16px] fs-16" type="button" data-accordion-target="#colorsetting" aria-expanded="true">
                        Top Bar Color
                    </button>
                </h2>
                <div id="colorsetting">
                    <div class="accordion-body p-3">
                       <div class="flex items-center flex-wrap gap-y-3">
                            ...
                            <div class="theme-colorselect m-1 me-3">
                                ...
                                <label for="darkaquaTopbar" class="darkaqua-topbar bg-[#116D6E]"></label>
                            </div>
                            <div class="theme-colorselect m-1 me-3">
                                <input type="radio" name="topbar" id="whiterockTopbar" value="whiterock">
                                <label for="whiterockTopbar" class="whiterock-topbar bg-[#F0E4D7]"></label>
                            </div>
                            <div class="theme-colorselect m-1 me-3">
                                <input type="radio" name="topbar" id="rockblueTopbar" value="rockblue">
                                <label for="rockblueTopbar" class="rockblue-topbar bg-[#8CB9BD]"></label>
                            </div>
                            <div class="theme-colorselect m-1 me-3">
                                <input type="radio" name="topbar" id="bluehazeTopbar" value="bluehaze">
                                <label for="bluehazeTopbar" class="bluehaze-topbar bg-[#B5C0D0]"></label>
                            </div>    
                             <div class="theme-colorselect m-1 me-3">
                        ...
                        <h6 class="mb-1 font-medium">Colors</h6>
                         <div class="flex items-center">
                            ...
                            <div class="theme-colorselect m-1 me-3">
                                ...
                                <label for="primaryTopbarcolor" class="primary-topbar bg-primary"></label>
                            </div>
                            <div class="theme-colorselect m-1 me-3">
                                <input type="radio" name="topbarcolor" id="blackpearlTopbarcolor" value="blackpearl">
                                <label for="blackpearlTopbarcolor" class="blackpearl-topbar bg-[#080821]"></label>
                            </div>
                            <div class="theme-colorselect m-1 me-3">
                                <input type="radio" name="topbarcolor" id="maroonTopbarcolor" value="maroon">
                                <label for="maroonTopbarcolor" class="maroon-topbar bg-[#710034]"></label>
                            </div>
                            <div class="theme-colorselect m-1 me-3">
                                <input type="radio" name="topbarcolor" id="bluegemTopbarcolor" value="bluegem">
                                <label for="bluegemTopbarcolor" class="bluegem-topbar bg-[#3E1C95]"></label>
                            </div>
                            <div class="theme-colorselect m-1 me-3">
                                <input type="radio" name="topbarcolor" id="fireflyTopbarcolor" value="firefly">
                                <label for="fireflyTopbarcolor" class="firefly-topbar bg-[#053333]"></label>
                            </div>                                           
                            <div class="theme-colorselect m-1 mt-0 hidden">
            ...
            <div class="accordion-item border rounded mb-4">
                <h2 class="accordion-header">
                    <button class="w-full p-3 rounded text-dark text-start text-[16px] fs-16" type="button" data-accordion-target="#sidebarbgsetting" aria-expanded="true">
                        Sidebar Background
                    </button>
                </h2>
                <div id="sidebarbgsetting">
                    <div class="accordion-body p-3 pb-1">
                       <div class="flex items-center flex-wrap">
                            <div class="theme-sidebarbg me-3 mb-3">
                                ...
                                <label for="sidebarBg1" class="block rounded">
                            ...
                            <div class="theme-sidebarbg me-3 mb-3">
                                ...
                                <label for="sidebarBg2" class="block rounded">
                            ...
                            <div class="theme-sidebarbg me-3 mb-3">
                                ...
                                <label for="sidebarBg3" class="block rounded">
                            ...
                            <div class="theme-sidebarbg me-3 mb-3">
                                ...
                                <label for="sidebarBg4" class="block rounded">
                            ...
                            <div class="theme-sidebarbg me-3 mb-3">
                                ...
                                <label for="sidebarBg5" class="block rounded">
                            ...
                            <div class="theme-sidebarbg me-3 mb-3">
                                ...
                                <label for="sidebarBg6" class="block rounded">
            ...
            <div class="accordion-item border rounded mb-4">
                <h2 class="accordion-header">
                    <button class="w-full p-3 rounded text-dark text-start text-[16px] fs-16" type="button" data-accordion-target="#sidebarcolor" aria-expanded="true">
                        Theme Colors
                    </button>
                </h2>
                <div id="sidebarcolor">
                    <div class="accordion-body p-3 pb-2">
                       <div class="flex items-center flex-wrap">
                            ...
                            <div class="theme-colorsset me-2 mb-2">
                                ...
                                <label for="brightblueColor" class="brightblue-clr before:bg-[#2066FF]"></label>
                            </div>
                            <div class="theme-colorsset me-2 mb-2">
                                <input type="radio" name="color" id="lunargreenColor" value="lunargreen" >
                                <label for="lunargreenColor" class="lunargreen-clr before:bg-[#365E32]"></label>
                            </div>
                            <div class="theme-colorsset me-2 mb-2">
                                <input type="radio" name="color" id="lavendarColor" value="lavendar">
                                <label for="lavendarColor" class="lavendar-clr before:bg-[#673AB7]"></label>
                            </div>
                            <div class="theme-colorsset me-2 mb-2">
                                <input type="radio" name="color" id="magentaColor" value="magenta">
                                <label for="magentaColor" class="magenta-clr before:bg-[#E83E8C]"></label>
                            </div>
                            <div class="theme-colorsset me-2 mb-2">
                                <input type="radio" name="color" id="chromeyellowColor" value="chromeyellow">
                                <label for="chromeyellowColor" class="chromeyellow-clr before:bg-[#FF9B04]"></label>
                            </div>  
                            <div class="theme-colorsset me-2 mb-2">
                                <input type="radio" name="color" id="lavaredColor" value="lavared">
                                <label for="lavaredColor" class="lavared-clr before:bg-[#DC2626]"></label>
                            </div>  
                           <div class="theme-colorsset mb-2 hidden">                                
            ...
            <div class="accordion-item border rounded mb-4">
                <h2 class="accordion-header">
                    <button class="w-full p-3 rounded text-dark text-start text-[16px] fs-16" type="button" data-accordion-target="#loadersetting" aria-expanded="true">
                        Preloader
                    </button>
                </h2>
                <div id="loadersetting">
                    <div class="accordion-body p-3">
                        <div class="flex items-center">
                            <div class="theme-width me-2">
                                <input type="radio" name="loader" id="enableLoader" value="enable" checked>
                                <label for="enableLoader" class="block rounded fs-12">With Preloader
                                </label>
                            </div>
                            <div class="theme-width">
                                <input type="radio" name="loader" id="disableLoader" value="disable">
                                <label for="disableLoader" class="block rounded fs-12">Without Preloader
                                </label>
                            </div>
                        </div>  
                    </div>
        ...
        <div class="p-3 pt-0">
            <div class="grid grid-cols-12 gap-x-3">
                <div class="col-span-6">
                    <a href="#" id="resetbutton" class="btn btn-light close-theme w-full"><i class="ti ti-restore me-1"></i>Reset</a>
                </div>
                <div class="col-span-6">
                    <a href="#" class="btn btn-primary w-full" data-bs-dismiss="offcanvas"><i class="ti ti-shopping-cart-plus me-1"></i>Buy Product</a>
                </div>
            </div>
        </div>    
    </div>

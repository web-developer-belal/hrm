...
<head>
	...
	<meta name="description" content="Baby shop HR - An advanced Bootstrap 5 admin dashboard template for HRM and CRM. Ideal for managing employee records, payroll, attendance, recruitment, and team performance with an intuitive and responsive design. Perfect for HR teams and business managers looking to streamline workforce management.">
...
<body class="antialiased bg-light text-default">
	...
	<div class="main-wrapper">
		...
		@include('partials.employ.header')

		@include('partials.employ.sidebar')

                ...
                <div class="card mb-5 border border-borderColor rounded-[5px] shadow-xs bg-white">
                    <div
                        ...
                        <span
                            ...
                            <img src="{{ customAsset($employee->photo, true, 'emp', $employee->first_anme) }}" class="rounded-full" alt="Img">
                        </span>
                                    ...
                                    <div class="accordion-body p-5">
                                        <div class="grid grid-cols-1 md:grid-cols-12 gap-y-4 gap-x-6">
                                            <div class="md:col-span-3">
                                                ...
                                                <h6 class="flex items-center fw-medium mt-1">{{$employee->bank_name}}
                                                </h6>
                                            </div>
                                            <div class="md:col-span-3">
                                                <span class="inline-flex items-center">
                                                ...
                                                <h6 class="flex items-center fw-medium mt-1">{{$employee->account_number}}</h6>
                                            </div>
                                            <div class="md:col-span-3">
                                                <span class="inline-flex items-center">
                                                    Routing No
                                                </span>
                                                <h6 class="flex items-center fw-medium mt-1">{{$employee->routing_number}}</h6>
                                            </div>
                                            {{-- <div class="md:col-span-3">
                                                <span class="inline-flex items-center">
                                                    Branch
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-12 gap-y-4 gap-x-6">
                                            ...
                                            <div class="md:col-span-2">
                                                ...
                                                <h6 class="flex items-center fw-medium mt-1">
                                                    <a href="{{ documentAsset($employee->resume) }}" target="_blank" class="btn btn-info"> View {{ getDocumentIcon($resume) }}</a>
                                            ...
                                            <div class="md:col-span-2">
                                                ...
                                                <h6 class="flex items-center fw-medium mt-1">
                                                    <a href="{{ documentAsset($employee->offer_letter) }}" target="_blank" class="btn btn-info"> View {{ getDocumentIcon($offerletter) }}</a>
                                            ...
                                            <div class="md:col-span-2">
                                                ...
                                                <h6 class="flex items-center fw-medium mt-1">
                                                    <a href="{{ documentAsset($employee->joining_letter) }}" target="_blank" class="btn btn-info"> View {{ getDocumentIcon($Joingletter) }}</a>
                                           ...
                                           <div class="md:col-span-2">
                                                ...
                                                <h6 class="flex items-center fw-medium mt-1">
                                                    <a href="{{ documentAsset($employee->contract_agreement) }}" target="_blank" class="btn btn-info"> View {{ getDocumentIcon($Contract) }}</a>
                                           ...
                                           <div class="md:col-span-2">
                                                ...
                                                <h6 class="flex items-center fw-medium mt-1">
                                                    <a href="{{ documentAsset($employee->Id_proof) }}" target="_blank" class="btn btn-info"> View {{ getDocumentIcon($idproof) }}</a>

                            ...
                            <tr class="even:bg-white dark:even-bg-white">
                                ...
                                <td class="px-5 py-2.5 text-gray-500">
                                    <div class="action-icon inline-flex">
                                        ...
                                        <button title="Delete" wire:confirm="Are you sure to delete this designation?"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-12 gap-y-4 gap-x-6 mb-2">
                                    ...
                                    <div class="md:col-span-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" wire:model.live="dearAllowanceAmount"
                                                class="bg-white border-borderColor text-gray-900 text-sm rounded-input  block w-full py-2 px-2.5 h-[38px] placeholder:text-gray-400">
                                            @error('dearAllowanceAmount')
                                                <span>{{ $message }}</span>
                                            @enderror
                                        </div>
                                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-12 gap-y-4 gap-x-6 mb-2">
                                    ...
                                    <div class="md:col-span-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" wire:model.live="pfEmployerContributionPercent"
                                                class="bg-white border-borderColor text-gray-900 text-sm rounded-input  block w-full py-2 px-2.5 h-[38px] placeholder:text-gray-400">
                                            @error('pfEmployerContributionPercent')
                                                <span>{{ $message }}</span>
                                            @enderror
                                        </div>
                                    </div>
                                    <div class="md:col-span-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" wire:model.live="pfEmployerContributionAmount"
                                                class="bg-white border-borderColor text-gray-900 text-sm rounded-input  block w-full py-2 px-2.5 h-[38px] placeholder:text-gray-400">
                                            @error('pfEmployerContributionAmount')
                                                <span>{{ $message }}</span>
                                            @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-12 gap-y-4 gap-x-6 mb-2">
                                        ...
                                        <div class="md:col-span-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" wire:model.live="welfareContributionPercent"
                                                    class="bg-white border-borderColor text-gray-900 text-sm rounded-input  block w-full py-2 px-2.5 h-[38px] placeholder:text-gray-400">
                                                @error('welfareContributionPercent')
                                                    <span>{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>

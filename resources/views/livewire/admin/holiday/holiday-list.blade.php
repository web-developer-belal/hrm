<div>
    ...
    <div class="md:flex block items-center justify-between page-breadcrumb mb-4">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Holiday Management</h2>
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li class="text-xs text-default">Holiday Management</li>
        ...
        <div class="flex my-xl-auto right-content items-center flex-wrap ">
            ...
            <div class="mb-2">
                <a href="{{ route('admin.holiday.add') }}"
                        ...
                        @foreach ($holydays as $item)
                            <tr class="even:bg-white dark:even-bg-white">
                                <td class="px-5 py-2.5 text-gray-500">
                                    {{ $holydays->firstItem() + $loop->index }}
                                </td>
                                <td class="px-5 py-2.5 text-gray-900">{{ $item->branch->name ?? 'All Branch'}}</td>
                                <td class="px-5 py-2.5 text-gray-500">{{ $item->name }}</td>
                                <td class="px-5 py-2.5 text-gray-500">{{ $item->date }}</td>

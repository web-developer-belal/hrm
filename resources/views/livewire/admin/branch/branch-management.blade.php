        ...
        <div class="my-auto mb-2">
            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li class="text-xs text-default">Branch Management</li>
            ...
            <div class="mb-2">
                <a href="{{ route('admin.branches.create') }}"
                    class="flex items-center bg-primary text-sm font-medium py-2 rounded text-white px-3 hover:bg-primary-900 hover:text-white"><i
                        class="ti ti-circle-plus me-2"></i>Add Branch</a>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-borderColor">
                        @foreach ($branches as $item)
                            <tr class="even:bg-white dark:even-bg-white">
                                ...
                                <td class="px-5 py-2.5 text-gray-500">{{ $item->contact }}</td>
                                <td class="px-5 py-2.5 text-gray-500">{{ $item->address }}</td>

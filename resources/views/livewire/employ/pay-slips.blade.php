                            ...
                            <tr class="hover:bg-gray-50 cursor-pointer">
                                ...
                                <td class="px-5 py-2.5 text-gray-500 p-3">
                                    <div class="flex items-center file-name-icon">
                                        ...
                                        <div class="ms-2">
                                            <h6 class="font-medium"><span
                                                    class="text-gray-900 hover:text-primary">{{ $pay->employee->first_name . ' ' . $pay->employee->last_name }}</span>
                                            </h6>
                                ...
                                <td class="px-5 py-2.5">
                                    <a href="{{ route('employee.payslips.show', ['payslip' => $pay->id]) }}"

                        ...
                        <li class="submenu mb-[5px]">
                            ...
                            <ul
                                ...
                                <li><a href="{{ route('admin.device.history') }}"
                                        class="relative flex items-center w-full text-xs leading-normal p-2 ps-8 text-gray-500 hover:text-primary">Device
                                        Sync History</a>
                                </li>
                        ...
                        <li class="submenu mb-[5px]">
                            ...
                            <ul
                                ...
                                <li><a href="{{ route('admin.transfer.new') }}"
                                        class="relative flex items-center w-full text-xs leading-normal p-2 ps-8 text-gray-500 hover:text-primary">Transfer
                                        New</a>
                                </li>
                        ...
                        <li class="submenu mb-[5px]">
                            ...
                            <ul
                                ...
                                <li><a href="{{ route('admin.holiday.index') }}"
                                        class="relative flex items-center w-full text-xs leading-normal p-2 ps-8 text-gray-500 hover:text-primary">Holiday Management</a></li>
                            </ul>
                        </li>
